...
package com.kmshack.tldetector.env;

import android.content.Context;
import android.graphics.Bitmap;
import android.graphics.Matrix;

import com.kmshack.tldetector.Utils;
...
public class ImageUtils {
     ...
     */
    public static String saveBitmap(Context context, final Bitmap bitmap) {
        return saveBitmap(context, bitmap, "image.png");
    }
     ...
     */
    public static String saveBitmap(Context context, final Bitmap bitmap, final String filename) {
        final String root = Utils.getModelFile(context, "tensorflow").getAbsolutePath();
